...
#include "src/core/full_rebase.h"
...
using kv_index::core::BuildCompactedDeltaSnapshot;
using kv_index::core::BuildRebasedFullSnapshot;
using kv_index::core::CompactionBuildRequest;
using kv_index::core::FinishDeltaCompaction;
using kv_index::core::FinishDeltaCompactionRequest;
...
using kv_index::core::UpdateApplier;
using kv_index::core::UpdateApplierOptions;
using kv_index::core::UpdateGenerationRole;
using kv_index::core::UpdateTargetRoute;
