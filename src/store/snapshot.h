#ifndef KV_INDEX_SRC_STORE_SNAPSHOT_H_
#define KV_INDEX_SRC_STORE_SNAPSHOT_H_
...
class SnapshotBacking {
 public:
  ...
  virtual StatusOr<model::EncodedRow> EncodedRowAt(
...
class OwnedSnapshotBacking final : public SnapshotBacking {
 public:
  ...
  StatusOr<model::EncodedRow> EncodedRowAt(
